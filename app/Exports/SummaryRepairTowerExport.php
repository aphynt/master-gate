...
class SummaryRepairTowerExport implements FromCollection, WithEvents, WithStyles, WithDrawings, Responsable, WithTitle
{
    use \Maatwebsite\Excel\Concerns\Exportable;

    private $data;
    private $fileName = 'Tower_Repair_FMS_Report.xlsx';
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Tower Repair Monthly Summary');
                ...
                foreach ($this->data as $index => $item) {
                    ...
                    $sheet->setCellValue("B{$row}", $item->NAMA_TOWER);
