@include('layout.head', ['title' => 'Edit Activity Unit'])
        ...
        <div class="page-title-box">
            ...
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                <div class="flex-grow-1">
                    <h4 class="font-18 mb-0">Edit Activity Unit</h4>
                </div>
            </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-fixed">
                                        ...
                                        <tbody id="activity-table">
                                            ...
                                            <tr>
                                                <input type="text" class="form-control" name="data[{{ $i }}][UUID]" value="{{ $un->UUID }}" required hidden>
                                                <td>
                                                    <select class="form-control unit-select" data-toggle="select2"
                                                        name="data[{{ $i }}][UUID_UNIT]" required>
                                                        <option value="{{ $un->UUID_UNIT }}">{{ $un->NAMA_UNIT }}</option>
                                                        @foreach ($unit as $unt)
                                                ...
                                                <td>
                                                    <textarea class="form-control" name="data[{{ $i }}][ACTUAL_PROBLEM]">{{ $un->ACTUAL_PROBLEM }}</textarea>
                                                </td>
                                                <td>
                                                    <textarea class="form-control" name="data[{{ $i }}][ACTION_PROBLEM]">{{ $un->ACTION_PROBLEM }}</textarea>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control clockpicker" value="{{ $un->START }}" name="data[{{ $i }}][START]" required>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control clockpicker" value="{{ $un->FINISH }}" name="data[{{ $i }}][FINISH]" required>
                                                </td>
                                                <td>
                                                    <select class="form-control" data-toggle="select2"
                                                        name="data[{{ $i }}][STATUS]" required>
                                                        <option value="{{ $un->UUID_STATUS }}">{{ $un->NAMA_STATUS }}</option>
                                                ...
                                                <td>
                                                    <textarea class="form-control" name="data[{{ $i }}][REMARKS]">{{ $un->REMARKS }}</textarea>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
