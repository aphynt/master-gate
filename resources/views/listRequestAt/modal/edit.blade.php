<div id="editlistRequestAt{{ $item->UUID }}" class="modal-demo">
    <div class="d-flex w-100 p-3 bg-primary align-items-center justify-content-between">
        <h4 class="custom-modal-title">Edit Request At</h4>
    ...
    <div class="custom-modal-text text-muted">
        <form action="{{ route('listRequestAt.update', $item->UUID) }}" method="GET">
            @csrf
            <div class="mt-3">
