<div id="insertlistDescriptionProblem" class="modal-demo">
    <div class="d-flex w-100 p-3 bg-primary align-items-center justify-content-between">
        <h4 class="custom-modal-title">Tambah Description Problem</h4>
    ...
    <div class="custom-modal-text text-muted">
        <form action="{{ route('listDescriptionProblem.insert') }}" method="post">
            @csrf
            <div class="mt-3">
